...
"use strict";var e,t;Object.defineProperty(exports,"__esModule",{value:!0}),exports.HTML_ELEMENTS=exports.PHASE=exports.INPUT=exports.FONTS=exports.COLOURS=exports.WIN_SCORE=exports.BAT_WIDTH=exports.BAT_HEIGHT=exports.BALL_RADIUS=exports.BAT_SIDE_MARGIN=exports.LANDSCAPE_MIN_X=exports.LANDSCAPE_MAX_X=exports.GAME_HEIGHT=exports.GAME_WIDTH=exports.SCORES=exports.DIRECTION=exports.VERSION_NUMBER=void 0,exports.VERSION_NUMBER="0.3",function(e){e.Up="UP",e.Down="DOWN",e.Left="LEFT",e.Right="RIGHT"}(e=exports.DIRECTION||(exports.DIRECTION={})),function(e){e[e.SHOOT_ALIEN=1e3]="SHOOT_ALIEN"}(t=exports.SCORES||(exports.SCORES={})),exports.GAME_WIDTH=1e3,exports.GAME_HEIGHT=400,exports.LANDSCAPE_MAX_X=2650,exports.LANDSCAPE_MIN_X=0,exports.BAT_SIDE_MARGIN=20,exports.BALL_RADIUS=10,exports.BAT_HEIGHT=60,exports.BAT_WIDTH=8,exports.WIN_SCORE=11,exports.COLOURS={BACKGROUND:"#333",MAIN:"#00CC00",LANDSCAPE:"#FFF",BULLET:"#00FF00",white:"white"},exports.FONTS={TITLE:"30px arial",SCORE:"20px arial",SMALL:"12px arial"},exports.INPUT={UP:"ArrowUp",DOWN:"ArrowDown",LEFT:"ArrowLeft",RIGHT:"ArrowRight",SPACE:" ",X:"x"},exports.PHASE={START:"START",GAME:"GAME",END:"END"},exports.HTML_ELEMENTS={START_BUTTON:"startButton",RESTART_BUTTON:"restartButton",START_SCREEN:"startScreen",END_SCREEN:"endScreen",RESULT_TEXT:"resultText",SHIP_IMAGE:"ship",ALIEN_IMAGE:"alien",SCORE_RESULT:"scoreResult"};
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.TEXT=void 0,exports.TEXT={WIN:"YOU WIN!!!",LOSE:"YOU LOSE!!!",SCORE:"SCORE"};
},{}],"JHKJ":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.collisionDetection=void 0;var e=require("../gameControl/gameControl"),o=require("../screens/screenControl"),n=require("../common/gameConstants"),r=require("../common/gameText"),t=require("../common/htmlElements"),i=function(e,o){return o.x>e.x&&o.x<e.x+e.width&&o.y>e.y&&o.y<e.y+e.height};exports.collisionDetection=function(){e.bulletControl.bulletList.forEach(function(o){e.alienControl.alienList.forEach(function(r){i(r,o)&&(r.explode(),o.remove(),e.score.increase(n.SCORES.SHOOT_ALIEN))})}),e.alienControl.alienList.forEach(function(n){i(e.ship,n)&&(n.explode(),e.ship.explode(),e.stopAnimation(),o.showEndScreen(),t.scoreResult.innerHTML=r.TEXT.SCORE+": "+e.score.score)})};
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e,t=require("../gameControl/gameControl"),i=require("../common/htmlElements"),s=require("../common/gameConstants"),h={x:s.GAME_WIDTH/2-5,y:s.GAME_HEIGHT/2,speed:0,maxSpeed:8,direction:s.DIRECTION.Right,dx:0,dy:0};!function(e){e.FORWARD="FORWARD",e.BACKWARD="BACKWARD"}(e||(e={}));var a=function(){return function(a,r){var o=this;this.height=23,this.width=60,this.acceleration=.2,this.maxSpeed=6,this.x=h.x,this.y=h.y,this.speed=h.speed,this.shipDirection=s.DIRECTION.Right,this.moveDirection=null,this.dx=h.dx,this.dy=h.dy,this.spriteState=e.FORWARD,this.ctx=null,this.camera=null,this.margin=150,this.draw=function(){switch(o.spriteState){case e.FORWARD:o.ctx.drawImage(i.shipImage,0,0,o.width,o.height,o.x-o.camera.x,o.y-o.camera.y,o.width,o.height);break;case e.BACKWARD:o.ctx.drawImage(i.shipImage,o.width,0,o.width,o.height,o.x-o.camera.x,o.y-o.camera.y,o.width,o.height)}},this.reset=function(){o.x=h.x,o.y=h.y,o.speed=h.speed,o.dx=h.dx,o.dy=h.dy},this.setSpeed=function(e){"max"===e&&(o.speed=h.maxSpeed)},this.changeDirection=function(e){o.moveDirection=e,e!==s.DIRECTION.Right&&e!==s.DIRECTION.Left||(o.shipDirection=e)},this.shoot=function(){var e;o.shipDirection===s.DIRECTION.Right?(t.bulletControl.addBullet(),(e=t.bulletControl.bulletList)[e.length-1].shoot(o.x+o.width,o.y+o.height/2+2,o.shipDirection)):(t.bulletControl.addBullet(),(e=t.bulletControl.bulletList)[e.length-1].shoot(o.x-t.bullet.width,o.y+o.height/2+2,o.shipDirection))},this.explode=function(){o.y=-200},this.move=function(){switch(o.moveDirection){case s.DIRECTION.Up:o.y>0&&(o.y=o.y-o.speed);break;case s.DIRECTION.Down:o.y<s.GAME_HEIGHT-24&&(o.y=o.y+o.speed);break;case s.DIRECTION.Left:o.x>s.LANDSCAPE_MIN_X&&(o.x-o.camera.x-o.margin>0?(o.x=o.x-o.speed,o.spriteState=e.BACKWARD):(o.x=o.x-o.speed,o.spriteState=e.BACKWARD,o.camera.move(s.DIRECTION.Right)));break;case s.DIRECTION.Right:o.x<s.LANDSCAPE_MAX_X&&(o.x-o.camera.x+o.margin<s.GAME_WIDTH-o.width?(o.x=o.x+o.speed,o.spriteState=e.FORWARD):(o.x=o.x+o.speed,o.spriteState=e.FORWARD,o.camera.move(s.DIRECTION.Left)))}},this.stop=function(){o.speed=0},this.ctx=a,this.camera=r}}();exports.default=a;
},{"../gameControl/gameControl":"N6Qj","../common/htmlElements":"lvQy","../common/gameConstants":"RETV"}],"QOxy":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var n=require("../common/gameConstants"),t=function(){return function(t,e){var a=this;this.landscapeBaseline=5*n.GAME_HEIGHT/6,this.lineWidth=2,this.ctx=null,this.camera=null,this.mountain=function(n,t){var e=t,i=t;return a.ctx.moveTo(n,a.landscapeBaseline),a.ctx.lineTo(n+e,a.landscapeBaseline-i),a.ctx.lineTo(n+2*e,a.landscapeBaseline),n+2*t},this.flat=function(n,t){var e=t;return a.ctx.moveTo(n,a.landscapeBaseline),a.ctx.lineTo(n+e,a.landscapeBaseline),n+t},this.draw=function(){var t=0;a.ctx.strokeStyle=n.COLOURS.LANDSCAPE,a.ctx.lineWidth=a.lineWidth,a.ctx.beginPath(),a.ctx.moveTo(-a.camera.x,a.landscapeBaseline),t=200-a.camera.x,a.ctx.lineTo(t,a.landscapeBaseline);for(var e=0;e<3;e++)t=a.mountain(t,50),t=a.flat(t,30),t=a.mountain(t,70),t=a.flat(t,30),t=a.mountain(t,20),t=a.mountain(t,20),t=a.flat(t,120),t=a.mountain(t,10),t=a.mountain(t,10),t=a.mountain(t,10),t=a.flat(t,100),t=a.mountain(t,100);a.ctx.stroke()},this.ctx=t,this.camera=e}}();exports.default=t;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("../common/htmlElements"),t=require("../common/gameConstants"),i={x:t.LANDSCAPE_MAX_X,speed:3,maxSpeed:8,direction:t.DIRECTION.Right},s=function(){return function(s,n){var o=this;this.height=23,this.width=26,this.x=Math.random()*t.LANDSCAPE_MAX_X,this.y=Math.random()*t.GAME_HEIGHT/2,this.speed=i.speed,this.direction=t.DIRECTION.Right,this.moveDirection=null,this.ctx=null,this.camera=null,this.removed=!1,this.draw=function(){o.ctx.drawImage(e.alienImage,o.x-o.camera.x,o.y-o.camera.y)},this.spawn=function(){o.x=t.LANDSCAPE_MAX_X,o.y=Math.random()*t.GAME_HEIGHT/2,o.speed=i.speed},this.move=function(){o.x=o.x-o.speed},this.explode=function(){o.y=-200},this.remove=function(){o.removed=!0},this.ctx=s,this.camera=n}}();exports.default=s;
},{"../common/htmlElements":"lvQy","../common/gameConstants":"RETV"}],"eZ7n":[function(require,module,exports) {
"use strict";var t=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(exports,"__esModule",{value:!0});var e=t(require("./alien")),i=2e3,n=function(){return function(t,n){var a=this;this.alienList=[],this.ctx=null,this.camera=null,this.spawnTimer=null,this.startSpawn=function(){a.spawnTimer=setInterval(a.add,i)},this.stopSpawn=function(){clearInterval(a.spawnTimer)},this.add=function(){a.alienList.push(new e.default(a.ctx,a.camera))},this.move=function(){a.alienList.forEach(function(t){t.move(),t.x-a.camera.x<0&&t.remove()}),a.alienList=a.alienList.filter(function(t){return!t.removed})},this.draw=function(){a.alienList.forEach(function(t){return t.draw()})},this.ctx=t,this.camera=n}}();exports.default=n;
},{"./alien":"K9ET"}],"qF6H":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var t=require("../common/gameConstants"),e=function(){return function(e,s){var i=this;this.x=0,this.y=0,this.minX=0,this.maxX=1700,this.speed=8,this.move=function(e){e===t.DIRECTION.Left&&i.x<i.maxX&&(i.x=i.x+i.speed),e===t.DIRECTION.Right&&i.x>i.minX&&(i.x=i.x-i.speed)},this.x=e,this.y=s}}();exports.default=e;
},{"../common/gameConstants":"RETV"}],"Lfcq":[function(require,module,exports) {
...
"use strict";var e=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0}),exports.stopAnimation=exports.init=exports.alienControl=exports.bulletControl=exports.camera=exports.ctx=exports.landscape=exports.bullet=exports.alien=exports.ship=exports.score=void 0;var t,r=require("../common/gameConstants"),o=require("../common/htmlElements"),s=require("./userInput"),n=require("./gameState"),a=require("../collision/collision"),l=e(require("../elements/ship")),i=e(require("../elements/landscape")),p=e(require("../elements/bullet")),x=e(require("../elements/bulletControl")),u=e(require("../elements/alienControl")),c=e(require("../camera/camera")),m=e(require("./score")),d=require("../elements/background");exports.init=function(){exports.ctx=o.gameCanvas.getContext("2d"),exports.camera=new c.default(0,0),exports.ship=new l.default(exports.ctx,exports.camera),exports.bullet=new p.default(exports.ctx,exports.camera),exports.bulletControl=new x.default(exports.ctx,exports.camera),exports.alienControl=new u.default(exports.ctx,exports.camera),exports.score=new m.default(exports.ctx),exports.alienControl.startSpawn(),exports.landscape=new i.default(exports.ctx,exports.camera),n.gameState.phase=r.PHASE.GAME,t||w()};var f=function(){d.clearCanvas(),d.drawBackground(),exports.landscape.draw(),exports.ship.draw(),exports.alienControl.draw(),exports.bulletControl.draw(),exports.score.draw(),d.drawVersionNumber()},q=function e(){exports.ship.move(),exports.alienControl.move(),exports.bulletControl.move(),f(),a.collisionDetection(),t=requestAnimationFrame(e)},w=function(){t=requestAnimationFrame(q)};exports.stopAnimation=function(){n.resetElements(),cancelAnimationFrame(t)},s.initUserInput();
},{"../common/gameConstants":"RETV","../common/htmlElements":"lvQy","./userInput":"ge9R","./gameState":"StvJ","../collision/collision":"JHKJ","../elements/ship":"D48b","../elements/landscape":"QOxy","../elements/bullet":"AsdF","../elements/bulletControl":"kXv4","../elements/alienControl":"eZ7n","../camera/camera":"qF6H","./score":"Lfcq","../elements/background":"TpTj"}]},{},["N6Qj"], null)
//# sourceMappingURL=docs/gameControl.3f5697c6.js.map