...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"common/gameConstants.ts":[function(require,module,exports) {
"use strict";
...
exports.gameCanvas = exports.alienImage = exports.shipImage = exports.scoreResult = exports.resultText = exports.endScreen = exports.startScreen = exports.restartButton = exports.startButton = void 0;
...
exports.startScreen = document.getElementById(gameConstants_1.HTML_ELEMENTS.START_SCREEN);
...
exports.scoreResult = document.getElementById(gameConstants_1.HTML_ELEMENTS.SCORE_RESULT);
exports.shipImage = document.getElementById(gameConstants_1.HTML_ELEMENTS.SHIP_IMAGE);
exports.alienImage = document.getElementById(gameConstants_1.HTML_ELEMENTS.ALIEN_IMAGE);
...
},{"./_baseClone":"../node_modules/lodash/_baseClone.js"}],"gameControl/gameState.ts":[function(require,module,exports) {
"use strict";
...
var detectKeyDownPress = function detectKeyDownPress(key) {
  if (gameState_1.gameState.phase == gameConstants_1.PHASE.GAME) {
    switch (key) {
      ...
      case gameConstants_1.INPUT.SPACE:
        gameControl_1.ship.shoot();
        break;
    }
  }
};
...
},{"../common/htmlElements":"common/htmlElements.ts","../common/gameConstants":"common/gameConstants.ts","./gameControl":"gameControl/gameControl.ts","../screens/screenControl":"screens/screenControl.ts","./gameState":"gameControl/gameState.ts"}],"common/gameText.ts":[function(require,module,exports) {
"use strict";
...
exports.collisionDetection = function () {
  gameControl_1.bulletControl.bulletList.forEach(function (bullet) {
    gameControl_1.alienControl.alienList.forEach(function (alien) {
      if (isCollide(alien, bullet)) {
        alien.explode();
        bullet.remove();
        gameControl_1.score.increase(gameConstants_1.SCORES.SHOOT_ALIEN);
      }
    });
  });
  gameControl_1.alienControl.alienList.forEach(function (alien) {
...
},{"../gameControl/gameControl":"gameControl/gameControl.ts","../screens/screenControl":"screens/screenControl.ts","../common/gameConstants":"common/gameConstants.ts","../common/gameText":"common/gameText.ts","../common/htmlElements":"common/htmlElements.ts"}],"elements/ship.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function Ship(ctx, camera) {
    ...
    this.shipDirection = gameConstants_1.DIRECTION.Right;
    ...
    this.draw = function () {
      switch (_this.spriteState) {
        case SPRITE_STATES.FORWARD:
          _this.ctx.drawImage(htmlElements_1.shipImage, 0, 0, _this.width, _this.height, _this.x - _this.camera.x, _this.y - _this.camera.y, _this.width, _this.height);

          break;

        case SPRITE_STATES.BACKWARD:
          _this.ctx.drawImage(htmlElements_1.shipImage, _this.width, 0, _this.width, _this.height, _this.x - _this.camera.x, _this.y - _this.camera.y, _this.width, _this.height);
    ...
    this.setSpeed = function (speed) {
      if (speed === "max") {
        _this.speed = INITIAL_STATE.maxSpeed;
      }
    };

    this.changeDirection = function (newDirection) {
      _this.moveDirection = newDirection;

      if (newDirection === gameConstants_1.DIRECTION.Right || newDirection === gameConstants_1.DIRECTION.Left) {
        _this.shipDirection = newDirection;
      }
    };

    this.shoot = function () {
      if (_this.shipDirection === gameConstants_1.DIRECTION.Right) {
        gameControl_1.bulletControl.addBullet();
        var bulletList = gameControl_1.bulletControl.bulletList;
        bulletList[bulletList.length - 1].shoot(_this.x + _this.width, _this.y + _this.height / 2 + 2, _this.shipDirection);
      } else {
        gameControl_1.bulletControl.addBullet();
        var bulletList = gameControl_1.bulletControl.bulletList;
        bulletList[bulletList.length - 1].shoot(_this.x - gameControl_1.bullet.width, _this.y + _this.height / 2 + 2, _this.shipDirection);
      }
    };
...
},{"../gameControl/gameControl":"gameControl/gameControl.ts","../common/htmlElements":"common/htmlElements.ts","../common/gameConstants":"common/gameConstants.ts"}],"elements/landscape.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function Landscape(ctx, camera) {
    var _this = this;

    this.landscapeBaseline = 5 * gameConstants_1.GAME_HEIGHT / 6;
    this.lineWidth = 2;
    this.ctx = null;
    this.camera = null;
    ...
    this.mountain = function (currentX, size) {
      ...
      var mountainHeight = size;

      _this.ctx.moveTo(currentX, _this.landscapeBaseline);
    ...
    this.flat = function (currentX, length) {
      var flatWidth = length;

      _this.ctx.moveTo(currentX, _this.landscapeBaseline);

      _this.ctx.lineTo(currentX + flatWidth, _this.landscapeBaseline);
    ...
    this.draw = function () {
      ...
      _this.ctx.lineTo(currentX, _this.landscapeBaseline);

      for (var i = 0; i < 3; i++) {
        currentX = _this.mountain(currentX, 50);
        currentX = _this.flat(currentX, 30);
        currentX = _this.mountain(currentX, 70);
        currentX = _this.flat(currentX, 30);
        currentX = _this.mountain(currentX, 20);
        currentX = _this.mountain(currentX, 20);
        currentX = _this.flat(currentX, 120);
        currentX = _this.mountain(currentX, 10);
        currentX = _this.mountain(currentX, 10);
        currentX = _this.mountain(currentX, 10);
        currentX = _this.flat(currentX, 100);
...
},{"../common/gameConstants":"common/gameConstants.ts"}],"elements/bullet.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function Bullet(ctx, camera) {
    ...
    this.draw = function () {
      _this.ctx.strokeStyle = gameConstants_1.COLOURS.BULLET;
      _this.ctx.lineWidth = _this.lineWidth;

      _this.ctx.beginPath();

      _this.ctx.moveTo(_this.x - _this.camera.x, _this.y);

      _this.ctx.lineTo(_this.x + _this.width - _this.camera.x, _this.y);
    ...
    this.shoot = function (x, y, direction) {
      _this.active = true;
      _this.x = x;
      _this.y = y;
    ...
    this.move = function () {
      if (_this.active) {
        if (_this.direction === gameConstants_1.DIRECTION.Right) {
          _this.x = _this.x + _this.speed;
        } else {
          _this.x = _this.x - _this.speed;
        }
...
},{"../common/gameConstants":"common/gameConstants.ts"}],"elements/bulletControl.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function BulletControl(ctx, camera) {
    var _this = this;
    ...
    this.addBullet = function () {
      _this.bulletList.push(new bullet_1.default(_this.ctx, _this.camera));
    };
    ...
    this.move = function () {
      _this.bulletList.forEach(function (bullet) {
        ...
        if (bullet.x > gameConstants_1.LANDSCAPE_MAX_X + _this.camera.x || bullet.x - _this.camera.x < 0) {
          bullet.remove();
        }
      });

      _this.bulletList = _this.bulletList.filter(function (x) {
        return !x.removed;
      });
    };
...
},{"../common/gameConstants":"common/gameConstants.ts","./bullet":"elements/bullet.ts"}],"elements/alien.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function Alien(ctx, camera) {
    ...
    this.draw = function () {
      _this.ctx.drawImage(htmlElements_1.alienImage, _this.x - _this.camera.x, _this.y - _this.camera.y);
    };
...
},{"../common/htmlElements":"common/htmlElements.ts","../common/gameConstants":"common/gameConstants.ts"}],"elements/alienControl.ts":[function(require,module,exports) {
"use strict";
...
var alien_1 = __importDefault(require("./alien"));

var ALIEN_SPAWN_INTERVAL = 2000;

var AlienControl =
/** @class */
function () {
  function AlienControl(ctx, camera) {
    var _this = this;
    ...
    this.startSpawn = function () {
      _this.spawnTimer = setInterval(_this.add, ALIEN_SPAWN_INTERVAL);
    };

    this.stopSpawn = function () {
      clearInterval(_this.spawnTimer);
    };
    ...
    this.move = function () {
      ...
      _this.alienList = _this.alienList.filter(function (x) {
        return !x.removed;
      });
    };
...
exports.default = AlienControl;
},{"./alien":"elements/alien.ts"}],"camera/camera.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function Score(ctx) {
    ...
    this.draw = function () {
      ...
      _this.ctx.font = gameConstants_1.FONTS.SCORE;
      _this.ctx.textAlign = "center";

      _this.ctx.fillText(gameText_1.TEXT.SCORE + ": " + _this.score.toString(), gameConstants_1.GAME_WIDTH / 2, 40);
    };
...
exports.drawBackground = exports.drawVersionNumber = exports.clearCanvas = void 0;
...
exports.clearCanvas = function () {
  gameControl_1.ctx.clearRect(0, 0, gameConstants_1.GAME_WIDTH, gameConstants_1.GAME_HEIGHT);
};

exports.drawVersionNumber = function () {
  gameControl_1.ctx.fillStyle = gameConstants_1.COLOURS.white;
  gameControl_1.ctx.font = gameConstants_1.FONTS.SMALL;
  gameControl_1.ctx.textAlign = "left";
  gameControl_1.ctx.fillText("Version: " + gameConstants_1.VERSION_NUMBER, gameConstants_1.GAME_WIDTH - 75, gameConstants_1.GAME_HEIGHT - 10);
};
...
var collision_1 = require("../collision/collision"); // import { moveOpponent } from "../ai/ai";


var ship_1 = __importDefault(require("../elements/ship"));

var landscape_1 = __importDefault(require("../elements/landscape"));

var bullet_1 = __importDefault(require("../elements/bullet"));

var bulletControl_1 = __importDefault(require("../elements/bulletControl"));

var alienControl_1 = __importDefault(require("../elements/alienControl"));

var camera_1 = __importDefault(require("../camera/camera"));
...
var animationRequest; // TODO - Make this file a class

exports.init = function () {
  exports.ctx = htmlElements_1.gameCanvas.getContext("2d");
  exports.camera = new camera_1.default(0, 0);
  exports.ship = new ship_1.default(exports.ctx, exports.camera);
  exports.bullet = new bullet_1.default(exports.ctx, exports.camera);
...
var drawGameElements = function drawGameElements() {
  background_1.clearCanvas();
  background_1.drawBackground();
  exports.landscape.draw();
  exports.ship.draw();
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","gameControl/gameControl.ts"], null)
//# sourceMappingURL=/gameControl.d2433721.js.map